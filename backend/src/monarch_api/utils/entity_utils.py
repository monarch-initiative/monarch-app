...
def get_associated_entity(association: Association, this_entity: Entity) -> Entity:
    ...
    """
    if association.subject == this_entity.id or this_entity.id in association.subject_closure:
        entity = Entity(
            id=association.object,
            name=association.object_label,
            category=association.object_category,
        )
    elif association.object == this_entity.id or this_entity.id in association.object_closure:
        entity = Entity(
