...
def _annotate(content: str = Path(title="The text content to annotate")) -> List[AnnotatedJSONResult]:
...
def _post_annotate(request: TextAnnotationRequest) -> List[AnnotatedJSONResult]:
