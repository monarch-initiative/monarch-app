...
class TextAnnotationPosition(ConfiguredBaseModel):
...
class TextAnnotationResult(ConfiguredBaseModel):
    ...
    positions: Optional[List[TextAnnotationPosition]] = Field(
        default_factory=list, description="""A collection of positions for matches within a text annotation result"""
    )
...
TextAnnotationPosition.update_forward_refs()
