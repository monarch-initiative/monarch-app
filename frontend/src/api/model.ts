...
export type CounterpartAssociationId = string;
...
export interface Association {
    ...
    /** Field containing subject id and the ids of all of its ancestors */
    subject_closure?: string[],
    /** The name of the subject entity */
    subject_label?: string,
    /** Field containing subject name and the names of all of its ancestors */
    ...
    /** Field containing object id and the ids of all of its ancestors */
    object_closure?: string[],
    /** The name of the object entity */
    object_label?: string,
    /** Field containing object name and the names of all of its ancestors */
    ...
    /** Field containing frequency_qualifier id and the ids of all of its ancestors */
    frequency_qualifier_closure?: string[],
    /** Field containing frequency_qualifier name and the names of all of its ancestors */
    ...
    /** Field containing onset_qualifier id and the ids of all of its ancestors */
    onset_qualifier_closure?: string[],
    /** Field containing onset_qualifier name and the names of all of its ancestors */
    ...
    /** Field containing sex_qualifier id and the ids of all of its ancestors */
    sex_qualifier_closure?: string[],
    /** Field containing sex_qualifier name and the names of all of its ancestors */
    ...
    /** Field containing stage_qualifier id and the ids of all of its ancestors */
    stage_qualifier_closure?: string[],
    /** Field containing stage_qualifier name and the names of all of its ancestors */
...
export interface CounterpartAssociation {
    ...
    counterpart_namespace?: string,
    /** The category of the counterpart entity */
    counterpart_category?: string,
    /** Field containing counterpart id and the ids of all of its ancestors */
    counterpart_closure?: string[],
    /** The name of the counterpart entity */
    counterpart_label?: string,
    /** Field containing counterpart name and the names of all of its ancestors */
    counterpart_closure_label?: string[],
    counterpart_taxon?: string,
    counterpart_taxon_label?: string,
    predicate: string,
    primary_knowledge_source?: string,
    aggregator_knowledge_source?: string[],
    negated?: boolean,
...
export interface EntityAssociatedCategories {
    ...
    /** The namespace/prefix of the entity entity */
    entity_namespace?: string,
    /** The category of the entity entity */
    entity_category?: string,
    /** Field containing entity id and the ids of all of its ancestors */
    entity_closure?: string[],
    /** Field containing entity name and the names of all of its ancestors */
    entity_closure_label?: string[],
    entity_taxon?: string,
    entity_taxon_label?: string,
    /** A list of associated categories for the entity */
    associated_categories: AssociationsByCategory[],
};

export interface MultiEntityAssociationResults {
    offset_per_category: number,
    limit_per_category: number,
    /** A list of entities for which associations were found */
    entities: EntityAssociatedCategories[],
};
/**
