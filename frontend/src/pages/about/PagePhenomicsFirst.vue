...
<template>
  <AppSection>
    ...
    <div class="goals-banner offset-2 col-8">
        ...
        <ul>
            <li>Create a community-driven framework of interoperable phenotype definitions: The Unified Phenotype Ontology (uPheno)</li>
            <li>Harmonize human disease definitions: the Mondo Disease Ontology</li>
            <li>Create a community-wide phenotype exchange standard: Phenopackets</li>
        </ul>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <figure class="ecosystems phenopackets">
                <img src="src/assets/phenopackets-ecosystem.png"/>
                <figcaption>
