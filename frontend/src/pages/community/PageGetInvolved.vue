<template>
  ...
  <PageTitle id="get-involved" title="Get Involved" />

  <AppSection width="big" class="intro-section">
    <p class="intro-text">
...
.info-line .app-icon[data-icon="calendar-week"] {
  color: #007acc;
}

.info-line .app-icon[data-icon="envelope"] {
  color: #007acc;
}

.info-line .app-icon[data-icon="youtube"] {
  color: #ff0000;
}
